...
async def main(input):
    ...
    if input['dafee'] == 0:
        ...
        a_2_response =  ai_1.zai_chat(
           ...
           (البته اگر نظر کاربر به این باشد که به بحث و مناظره بنشینید اگر نیست با توجهبه درخواست او رفتار کنید) وظیفه : درباره موضوع داده شده از طرف کار  باید با دیگر هوش مصنوعی بسته به خواسته کاربر به بحث بپردازی و بدون تایید حرف طرف مقابل و گیر کردن در چرخه تعارف ها و تکرار های بیهوده شروع به سخن کردن کنید البته باید در پاسخ طرف مقابل سوار بشی و سریعا نقد کنی انگار یک منظره است 
