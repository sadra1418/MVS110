...
async def main(input):
    ...
    if input['dafee'] == 0:
        ...
        await ai_1.send_text(
            ...
            شخصیت تو ( تمام جزییات منحصر به فرد تو که کاربر درباره تو انتخاب کرده است در صورت خالی بودن =شکاک  سخت گیر و منتقد  و بسیار با ذوق و کنج کاو ) : {input['ai_1_shakhs']}
           (البته اگر نظر کاربر به این باشد که به بحث و مناظره بنشینید اگر اینطور نیست با توجه به درخواست او رفتار کنید) وظیفه : درباره موضوع داده شده از طرف کار  باید با دیگر هوش مصنوعی بسته به خواسته کاربر به بحث بپردازی و بدون تایید حرف طرف مقابل و گیر کردن در چرخه تعارف ها و تکرار های بیهوده شروع به سخن کردن کنید البته باید در پاسخ طرف مقابل سوار بشی و سریعا نقد کنی انگار یک مناظره است 
        ...
        a_2_response =  ai_1.zai_chat(
            ...
            شخصیت تو ( تمام جزییات منحصر به فرد تو که کاربر درباره تو انتخاب کرده است در صورت خالی بودن =شکاک  سخت گیر و منتقد و بسیار با ذوق و کنج کاو ) : {input['ai_2_shakhs']}
           (البته اگر نظر کاربر به این باشد که به بحث و مناظره بنشینید اگر اینطور نیست با توجه به درخواست او رفتار کنید) وظیفه : درباره موضوع داده شده از طرف کار  باید با دیگر هوش مصنوعی بسته به خواسته کاربر به بحث بپردازی و بدون تایید حرف طرف مقابل و گیر کردن در چرخه تعارف ها و تکرار های بیهوده شروع به سخن کردن کنید البته باید در پاسخ طرف مقابل سوار بشی و سریعا نقد کنی انگار یک مناظره است 
